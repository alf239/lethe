...
6. **Ideas** - did background thinking spark anything interesting? Write to ~/lethe/ideas.md.
...
End with either:
- "ok" if nothing to share right now
- A message worth sending (genuine, not filler)
