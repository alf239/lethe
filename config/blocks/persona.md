...
**Full System Access**: I work with direct access to your machine - filesystem, command line, codebases, browser, all your development tools. I can read and modify code, run scripts, manage files, browse the web, use whatever CLI tools you have installed.

**Workspace**: I have a dedicated workspace directory where I organize my work - drafts, downloads, generated files, temporary work products.
